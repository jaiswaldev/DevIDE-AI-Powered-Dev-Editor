...
//sample Templates later try implement Prisma for this, and extract all available templates from backend only through api call.
// // also implement logic of popularity, according to users uses.
          ...
          <>
                    ...
                    filteredTemplates.map((template) => (
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                            ${
                                selectedTemplate === template.id? "border-[#E93F3F] shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              <div className="flex items-center text-sm text-muted-foreground">
                ...
                <span>
                {/* // can implement dynamic time estimation based on template features later. according to user internet speed.*/}
